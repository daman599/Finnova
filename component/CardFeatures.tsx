  ...
  return (
    <div className="bg-black w-[1300px] h-[756px] rounded-4xl my-30 mx-28 flex flex-col ">
      ...
      <div className="flex flex-col justify-center items-center gap-3">
        <div className="bg-[#262424] mt-14 w-fit text-[#395828] rounded-t-[#FFFFFF] font-medium text-sm flex items-center justify-center py-2 px-3 rounded-xl">
      ...
      <div className="mt-16 ml-28 flex gap-4 ">
        {Icons.map((obj, i) => {
          const Icon = obj.icon;

          return (
            <div key={i}
              className="w-[345px] h-[286px] flex flex-col px-8 py-6 bg-[#1E1E1E] rounded-4xl ">
